...
- **Pro tier / AI vendor reviews, partner collaboration, day-of timeline, true drag-and-drop seating**: not built, per the spec's "Not in v1" list.
...
- `app/(tabs)/{checklist,budget,guests,wishlist}/page.tsx` — the other four tabs
